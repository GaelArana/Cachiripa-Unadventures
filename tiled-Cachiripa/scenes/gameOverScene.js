export class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        restartButton.on('pointerdown', () => {
            this.scene.stop('level1'); // Detener la escena Level1 si está activa
            this.scene.stop('GameOverScene'); // Detener esta escena de 
        ...
        menuButton.on('pointerdown', () => {
            this.scene.stop('GameOverScene'); // Detener esta escena de GameOver
            this.scene.start('StartScene'); // Iniciar la escena de menú principal
        });
    }
}